                        ...
                        >
                            ...
                            <tr>
                                <td align="center" style="padding: 30px 0;">
                                    <a href="{{ $url }}" style="font-family: 'Open Sans',sans-serif;font-weight: 400;text-decoration: none;display: inline-block;background: #3e3e3e;color: #fafafa;padding: 11px 30px;border: none;border-radius: 0;outline: 0;">
