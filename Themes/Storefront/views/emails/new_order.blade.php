...
>
    ...
    <body style="font-family: 'Open Sans', sans-serif;
                ...
                margin: 0;"
    >
        <table style="border-collapse: collapse; width: 100%; background: whitesmoke;">
            <tbody>
                <tr>
                    <td style="padding: 0;">
                        <table style="border-collapse: collapse; width: 100%;">
                            <tbody>
                                <tr>
                                    <td align="center" style="background: #3e3e3e;">
                                        @if (is_null($logo))
                                        ...
                                        @else
                                            ...
                                            >
                                                ...
                                                <img src="https://i.ibb.co/Sx9QHG9/logo.png" style="max-height: 100%; max-width: 100%;">
                                            </div>
                                        @endif
                                    </td>
                                </tr>
                        ...
                        >
                            ...
                            <tr>
                                <td align="center" style="padding: 30px 0;">
                                    <a href="{{ route('admin.orders.show', $order) }}" style="font-family: 'Open Sans',sans-serif;font-weight: 400;text-decoration: none;display: inline-block;background: #3e3e3e;color: #fafafa;padding: 11px 30px;border: none;border-radius: 0;outline: 0;"
                                    >
