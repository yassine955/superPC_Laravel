<div class="shipping-address clearfix {{ old('ship_to_a_different_address') ? '' : 'hide' }}">
    ...
    <div class="col-md-6">
        <div class="form-group {{ $errors->has('shipping.first_name') ? 'has-error': '' }}">
            ...
            <input type="text" placeholder="Naam" name="shipping[first_name]" value="{{ old('shipping.first_name') }}" class="form-control" id="shipping-first-name">
    ...
    <div class="col-md-6">
        <div class="form-group {{ $errors->has('shipping.first_name') ? 'has-error': '' }}">
            ...
            <input type="text" placeholder="Achternaam" name="shipping[last_name]" value="{{ old('shipping.last_name') }}" class="form-control" id="shipping-last-name">
    ...
    <div class="col-md-12">
        <div class="form-group {{ $errors->has('shipping.first_name') ? 'has-error': '' }}">
            ...
            <input type="text" placeholder="Adres" name="shipping[address_1]" value="{{ old('shipping.address_1') }}" class="form-control" id="shipping-address-1">
    ...
    <div class="col-md-12">
        <div class="form-group {{ $errors->has('shipping.first_name') ? 'has-error': '' }}">
            ...
            <input type="text" placeholder="Adres 2" name="shipping[address_2]" value="{{ old('shipping.address_2') }}" class="form-control" id="shipping-address-2">
    ...
    <div class="col-md-6">
        <div class="form-group {{ $errors->has('shipping.first_name') ? 'has-error': '' }}">
            ...
            <input type="text" placeholder="Stad" name="shipping[city]" value="{{ old('shipping.city') }}" class="form-control" id="shipping-city">
    ...
    <div class="col-md-6">
        <div class="form-group {{ $errors->has('shipping.first_name') ? 'has-error': '' }}">
            ...
            <input type="text" placeholder="Postcode" name="shipping[zip]" value="{{ old('shipping.zip') }}" class="form-control" id="shipping-zip">
