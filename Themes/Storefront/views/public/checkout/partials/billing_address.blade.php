<div class="billing-address clearfix">
    ...
    <div class="col-md-6">
        <div class="form-group {{ $errors->has('billing.first_name') ? 'has-error': '' }}">
            ...
            <input type="text" placeholder="Naam" name="billing[first_name]" value="{{ old('billing.first_name') }}" class="form-control" id="billing-first-name">
    ...
    <div class="col-md-6">
        <div class="form-group {{ $errors->has('billing.last_name') ? 'has-error': '' }}">
            ...
            <input type="text" placeholder="Achternaam" name="billing[last_name]" value="{{ old('billing.last_name') }}" class="form-control" id="billing-last-name">
    ...
    <div class="col-md-12">
        <div class="form-group {{ $errors->has('billing.address_1') ? 'has-error': '' }}">
            ...
            <input type="text" placeholder="Adres" name="billing[address_1]" value="{{ old('billing.address_1') }}" class="form-control" id="billing-address-1">
    ...
    <div class="col-md-12">
        <div class="form-group {{ $errors->has('billing.address_2') ? 'has-error': '' }}">
            ...
            <input type="text" placeholder="Adres 2" name="billing[address_2]" value="{{ old('billing.address_2') }}" class="form-control" id="billing-address-2">
    ...
    <div class="col-md-6">
        <div class="form-group {{ $errors->has('billing.city') ? 'has-error': '' }}">
            ...
            <input type="text" placeholder="Stad" name="billing[city]" value="{{ old('billing.city') }}" class="form-control" id="billing-city">
    ...
    <div class="col-md-6">
        <div class="form-group {{ $errors->has('billing.zip') ? 'has-error': '' }}">
            ...
            <input type="text" placeholder="Postcode" name="billing[zip]" value="{{ old('billing.zip') }}" class="form-control" id="billing-zip">
