                        ...
                        <div class="form-inner clearfix">
                            <div class="col-md-12">
                                <div class="form-group {{ $errors->has('first_name') ? 'has-error': '' }}">
                                    ...
                                    <input type="text" placeholder="Naam" name="first_name" value="{{ old('first_name') }}" class="form-control" id="first-name" autofocus>
                                ...
                                <div class="form-group {{ $errors->has('last_name') ? 'has-error': '' }}">
                                    ...
                                    <input type="text" placeholder="Achternaam" name="last_name" value="{{ old('last_name') }}" class="form-control" id="last-name">
                                ...
                                <div class="form-group {{ $errors->has('email') ? 'has-error': '' }}">
                                    ...
                                    <input type="text" placeholder="E-Mail" name="email" value="{{ old('email') }}" class="form-control" id="email">
                                ...
                                <div class="form-group {{ $errors->has('password') ? 'has-error': '' }}">
                                    ...
                                    <input type="password" placeholder="Wachtwoord" name="password" class="form-control" id="password">
                                ...
                                <div class="form-group {{ $errors->has('password_confirmation') ? 'has-error': '' }}">
                                    ...
                                    <input type="password" placeholder="Wachtwoord Verificatie" name="password_confirmation" class="form-control" id="confirm-password">
                                ...
                                <div class="form-group {{ $errors->has('captcha') ? 'has-error': '' }}">
                                    @captcha
                                    <input type="text" placeholder="Captcha" name="captcha" id="captcha" class="captcha-input">
