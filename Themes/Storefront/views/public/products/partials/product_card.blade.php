...
<a href="{{ route('products.show', $product->slug) }}" class="product-card">
    <div class="product-card-inner">
        ...
        <span class="product-price bottom_price">{{ product_price($product) }}</span>
        <span class="product-price bottom_clear"><i class="fa fa-check-circle" aria-hidden="true"></i> Morgen in huis</span>
