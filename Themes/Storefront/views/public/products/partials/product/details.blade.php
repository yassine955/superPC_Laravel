<div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
    <div class="product-details">
        ...
        <div class="detail_products_custom">
                
            <li><i class="fa fa-check-circle padding_fav" aria-hidden="true"></i> Voor 23:59 uur besteld, morgen in huis</li>
            <li><i class="fa fa-check-circle padding_fav" aria-hidden="true"></i> Gratis verzending voor alle bestellingen</li>
            <li><i class="fa fa-check-circle padding_fav" aria-hidden="true"></i> Gratis binnen 30 dagen te retourneren</li>
            <li><i class="fa fa-check-circle padding_fav" aria-hidden="true"></i> Alle onderdelen zijn op voorraad</li>
</div>
    </div>
</div>
